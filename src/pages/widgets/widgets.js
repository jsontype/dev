...
function Widgets() {
  ...
  useEffect(() => {
    ...
    fetch('/assets/data/widgets/widget-code-1..json', option)
    ...
    fetch('/assets/data/widgets/widget-code-2..json', option)
      .then(function (response) {
        return response.text()
      })
      .then(html => {
    ...
    fetch('/assets/data/widgets/widget-code-3..json', option)
      .then(function (response) {
        return response.text()
      })
      .then(html => {
    ...
    fetch('/assets/data/widgets/widget-code-4..json', option)
      .then(function (response) {
        return response.text()
      })
      .then(html => {
    ...
    fetch('/assets/data/widgets/widget-code-5..json', option)
      .then(function (response) {
        return response.text()
      })
      .then(html => {
    ...
    fetch('/assets/data/widgets/widget-code-6..json', option)
      .then(function (response) {
        return response.text()
      })
      .then(html => {
    ...
    fetch('/assets/data/widgets/widget-code-7..json', option)
      .then(function (response) {
        return response.text()
      })
      .then(html => {
    ...
    fetch('/assets/data/widgets/widget-code-8..json', option)
      .then(function (response) {
        return response.text()
      })
      .then(html => {
    ...
    fetch('/assets/data/widgets/widget-code-9..json', option)
      .then(function (response) {
        return response.text()
      })
      .then(html => {
    ...
    fetch('/assets/data/widgets/widget-code-10..json', option)
      .then(function (response) {
        return response.text()
      })
      .then(html => {
    ...
    fetch('/assets/data/widgets/widget-code-11..json', option)
      .then(function (response) {
        return response.text()
      })
      .then(html => {
          ...
          <div className="row">
            <div className="col-xl-9">
              ...
              <div id="cardWidget" className="mb-5">
                <h4>Card widget</h4>
                <p>
                  Card widget is created by using existing Bootstrap <code>.card</code> component
                  with <code>.card-img</code>, <code>.card-img-overlay</code> and{' '}
              ...
              <div id="listWidget" className="mb-5">
                <h4>List widget</h4>
                <p>
                  List widget is created by using existing Bootstrap <code>.list-group</code>{' '}
                  component with <code>.d-flex</code> and hud utilities css classes.
                </p>
                <Card>
                  <CardBody>
                    <div className="row">
                        ...
                        <div className="list-group mb-3">
                          ...
                          >
                            ...
                            <div className="flex-fill ps-3 d-flex align-items-center">
                              <div className="fw-bold flex-fill">Isaiah Hughes</div>
                          ...
                          >
                            ...
                            <div className="flex-fill ps-3 d-flex align-items-center">
                              <div className="fw-bold flex-fill">Ryan Turner</div>
              ...
              <div id="statsWidget" className="mb-5">
                <h4>Stats widget</h4>
                <p>
                  States widget is created by using Bootstrap <code>.card</code> component with{' '}
                  <code>.d-flex</code> and <code>background-color</code> utilities.
                </p>
                <Card>
                  <CardBody>
                    <div className="row">
              ...
              <div id="chartWidget" className="mb-5">
                ...
                <p>
                  ...
                  <code>.list-group</code> component combined with Chart.js plugins.
                </p>
                <Card>
                  <CardBody>
                    <div className="row">
              ...
              <div id="mapWidget" className="mb-5">
                <h4>Map widget</h4>
                <p>
                  Map widget created with Bootstrap <code>.card</code> and <code>.list-group</code>{' '}
              ...
              <div id="chatWidget" className="mb-5">
                <h4>Chat widget</h4>
                <p>
                  Chat widget created by using Bootstrap <code>.card</code> component with custom
                  created bubble chat ui.
                </p>
                <Card>
                  <CardBody>
                    <div className="row">
                            ...
                            <PerfectScrollbar className="h-200px p-3">
                              <div className="widget-chat">
                                ...
                                <div className="widget-chat-item reply">
                                  <div className="widget-chat-content">
                                    <div className="widget-chat-message last">Cool</div>
                                ...
                                <div className="widget-chat-item reply">
                                  <div className="widget-chat-content">
                                    <div className="widget-chat-message last">Sucks</div>
                                    <div className="widget-chat-status">
                                      <b>Read</b> 16:30
                                    </div>
                                  </div>
              ...
              <div id="profileWidget" className="mb-5">
                ...
                <p>
                  Profile widget created by using Bootstrap <code>.card</code> component with
                  Bootstrap grid.
                </p>
                <Card>
                  <CardBody>
              ...
              <div id="reminderWidget" className="mb-5">
                ...
                <p>
                  Reminder widget used to create a simple calendar to notify the user upcoming
                  events or task.
                </p>
                <Card>
                  <CardBody>
              ...
              <div id="imageListWidget" className="mb-5">
                ...
                <p>
                  Image list widget created by using Bootstrap <code>.card</code> and{' '}
                  <code>.list-group</code> component with <code>.d-flex</code> utilities.
                </p>
                <Card>
                  <CardBody>
                    <div className="row">
                              ...
                              <div className="widget-img-list-item">
                                <a href="/assets/img/gallery/gallery-1.jpg" data-lity>
                                  <span
                                    className="img"
                                    style={{
                                      backgroundImage: 'url(/assets/img/gallery/gallery-1.jpg)',
                                    }}
                                  ></span>
                                </a>
                              </div>
                              <div className="widget-img-list-item">
                                <a href="/assets/img/gallery/gallery-2.jpg" data-lity>
                                  <span
                                    className="img"
                                    style={{
                                      backgroundImage: 'url(/assets/img/gallery/gallery-2.jpg)',
                                    }}
                                  ></span>
                                </a>
                              </div>
                              <div className="widget-img-list-item">
                                <a href="/assets/img/gallery/gallery-3.jpg" data-lity>
                                  <span
                                    className="img"
                                    style={{
                                      backgroundImage: 'url(/assets/img/gallery/gallery-3.jpg)',
                                    }}
                                  ></span>
                                </a>
                              </div>
                              <div className="widget-img-list-item">
                                <a href="/assets/img/gallery/gallery-4.jpg" data-lity>
                                  <span
                                    className="img"
                                    style={{
                                      backgroundImage: 'url(/assets/img/gallery/gallery-4.jpg)',
                                    }}
                                  ></span>
                                </a>
                              </div>
                              <div className="widget-img-list-item">
                                <a href="/assets/img/gallery/gallery-5.jpg" data-lity>
                                  <span
                                    className="img"
                                    style={{
                                      backgroundImage: 'url(/assets/img/gallery/gallery-5.jpg)',
                                    }}
                                  ></span>
                                </a>
                              </div>
                              <div className="widget-img-list-item">
                                <a href="/assets/img/gallery/gallery-21.jpg" data-lity>
                                  <span
                                    className="img"
                                    style={{
                                      backgroundImage: 'url(/assets/img/gallery/gallery-21.jpg)',
                                    }}
                                  ></span>
                                </a>
                              </div>
                              <div className="widget-img-list-item">
                                <a href="/assets/img/gallery/gallery-22.jpg" data-lity>
                                  <span
                                    className="img"
                                    style={{
                                      backgroundImage: 'url(/assets/img/gallery/gallery-22.jpg)',
                                    }}
                                  ></span>
                                </a>
                              </div>
                              <div className="widget-img-list-item">
                                <a href="/assets/img/gallery/gallery-23.jpg" data-lity>
                                  <span
                                    className="img"
                                    style={{
                                      backgroundImage: 'url(/assets/img/gallery/gallery-23.jpg)',
                                    }}
                                  ></span>
                                </a>
                              </div>
                              <div className="widget-img-list-item">
                                <a href="/assets/img/gallery/gallery-24.jpg" data-lity>
                                  <span
                                    className="img"
                                    style={{
                                      backgroundImage: 'url(/assets/img/gallery/gallery-24.jpg)',
                                    }}
                                  ></span>
                                </a>
                              </div>
                              <div className="widget-img-list-item">
                                <a href="/assets/img/gallery/gallery-25.jpg" data-lity>
                                  <span
                                    className="img"
                                    style={{
                                      backgroundImage: 'url(/assets/img/gallery/gallery-25.jpg)',
                                    }}
                                  ></span>
                                </a>
                              </div>
                              <div className="widget-img-list-item">
                                <a href="/assets/img/gallery/gallery-26.jpg" data-lity>
                                  <span
                                    className="img"
                                    style={{
                                      backgroundImage: 'url(/assets/img/gallery/gallery-26.jpg)',
                                    }}
                                  ></span>
                                </a>
                              </div>
                              <div className="widget-img-list-item">
                                <a href="/assets/img/gallery/gallery-27.jpg" data-lity>
                                  <span
                                    className="img"
                                    style={{
                                      backgroundImage: 'url(/assets/img/gallery/gallery-27.jpg)',
                                    }}
                                  ></span>
                                </a>
                              </div>
                              <div className="widget-img-list-item">
                                <a href="/assets/img/gallery/gallery-28.jpg" data-lity>
                                  <span
                                    className="img"
                                    style={{
                                      backgroundImage: 'url(/assets/img/gallery/gallery-28.jpg)',
                                    }}
                                  ></span>
                                </a>
                              </div>
                              <div className="widget-img-list-item">
                                <a href="/assets/img/gallery/gallery-29.jpg" data-lity>
                                  <span
                                    className="img"
                                    style={{
                                      backgroundImage: 'url(/assets/img/gallery/gallery-29.jpg)',
                                    }}
                                  ></span>
                                </a>
                              </div>
                              <div className="widget-img-list-item">
                                <a href="/assets/img/gallery/gallery-30.jpg" data-lity>
                                  <span
                                    className="img"
                                    style={{
                                      backgroundImage: 'url(/assets/img/gallery/gallery-30.jpg)',
                                    }}
                                  ></span>
                                </a>
                              </div>
                              <div className="widget-img-list-item">
                                <a href="/assets/img/gallery/gallery-31.jpg" data-lity>
                                  <span
                                    className="img"
                                    style={{
                                      backgroundImage: 'url(/assets/img/gallery/gallery-31.jpg)',
                                    }}
                                  ></span>
                                </a>
                              </div>
                              <div className="widget-img-list-item">
                                <a href="/assets/img/gallery/gallery-32.jpg" data-lity>
                                  <span
                                    className="img"
                                    style={{
                                      backgroundImage: 'url(/assets/img/gallery/gallery-32.jpg)',
                                    }}
                                  ></span>
                                </a>
                              </div>
                              <div className="widget-img-list-item">
                                <a href="/assets/img/gallery/gallery-33.jpg" data-lity>
                                  <span
                                    className="img"
                                    style={{
                                      backgroundImage: 'url(/assets/img/gallery/gallery-33.jpg)',
                                    }}
                                  ></span>
                                </a>
                              </div>
                              <div className="widget-img-list-item">
                                <a href="/assets/img/gallery/gallery-34.jpg" data-lity>
                                  <span
                                    className="img"
                                    style={{
                                      backgroundImage: 'url(/assets/img/gallery/gallery-34.jpg)',
                                    }}
                                  ></span>
                                </a>
                              </div>
                              <div className="widget-img-list-item">
                                <a href="/assets/img/gallery/gallery-35.jpg" data-lity>
                                  <span
                                    className="img"
                                    style={{
                                      backgroundImage: 'url(/assets/img/gallery/gallery-35.jpg)',
                                    }}
                                  ></span>
                                </a>
                              </div>
            ...
            <div className="col-xl-3">
              <NavScrollTo>
                <nav className="nav">
                  <a className="nav-link" href="#cardWidget" data-toggle="scroll-to">
                    Card widget
                  </a>
                  <a className="nav-link" href="#listWidget" data-toggle="scroll-to">
                    List widget
                  </a>
                  <a className="nav-link" href="#statsWidget" data-toggle="scroll-to">
                    Stats widget
                  </a>
                  <a className="nav-link" href="#chartWidget" data-toggle="scroll-to">
                    Chart widget
                  </a>
                  <a className="nav-link" href="#userListWidget" data-toggle="scroll-to">
                    User list widget
                  </a>
                  <a className="nav-link" href="#mapWidget" data-toggle="scroll-to">
                    Map widget
                  </a>
                  <a className="nav-link" href="#chatWidget" data-toggle="scroll-to">
                    Chat widget
                  </a>
                  <a className="nav-link" href="#profileWidget" data-toggle="scroll-to">
                    Profile widget
                  </a>
                  <a className="nav-link" href="#productWidget" data-toggle="scroll-to">
                    Product widget
                  </a>
                  <a className="nav-link" href="#reminderWidget" data-toggle="scroll-to">
                    Reminder widget
                  </a>
                  <a className="nav-link" href="#imageListWidget" data-toggle="scroll-to">
                    Image list widget
                  </a>
                </nav>
              </NavScrollTo>

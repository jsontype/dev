          ...
          <div className="fc-event-list" id="external-events">
            ...
            <div className="fc-event-item">
              <div className="fc-event-link" data-color="#ff3b30">
                <i className="fa fa-circle fs-8px me-2 text-danger"></i> Group Discussion
              </div>
            </div>
            <div className="fc-event-item">
              <div className="fc-event-link" data-color="#FF9500">
                <i className="fa fa-circle fs-8px me-2 text-warning"></i> Brainstorming
              </div>
            </div>
            <div className="fc-event-item">
              <div className="fc-event-link" data-color="#FFCC00">
                <i className="fa fa-circle fs-8px me-2 text-yellow"></i> Presentation
              </div>
            </div>
            <div className="fc-event-item">
              <div className="fc-event-link" data-color="#1ABD36">
                <i className="fa fa-circle fs-8px me-2 text-success"></i> Holiday
              </div>
            </div>
            <div className="fc-event-item">
              <div className="fc-event-link" data-color="#0cd096">
                <i className="fa fa-circle fs-8px me-2 text-theme"></i> Sick Leave
              </div>
            </div>
            <div className="fc-event-item">
            ...
            <div className="fc-event-item">
              <div className="fc-event-link" data-color="#1f6bff">
                <i className="fa fa-circle fs-8px me-2 text-blue"></i> Work from Home
              </div>
            </div>
            <div className="fc-event-item">
              <div className="fc-event-link" data-color="#640DF3">
                <i className="fa fa-circle fs-8px me-2 text-indigo"></i> Business Travel
              </div>
            </div>
            <div className="fc-event-item">
              <div className="fc-event-link" data-color="#5b2e91">
                <i className="fa fa-circle fs-8px me-2 text-purple"></i> Breakfast
              </div>
            </div>
            <div className="fc-event-item">

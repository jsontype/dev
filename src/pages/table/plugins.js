        ...
        <div className="col-xl-10">
          <div className="row">
            <div className="col-xl-9">
              ...
              <div id="datatable" className="mb-5">
                ...
                <p>
                  ...
                  these advanced features to any HTML table. Please read the{' '}
                  <a href="https://datatables.net/" target="_blank" rel="noreferrer">
            ...
            <div className="col-xl-3">
              <NavScrollTo>
                <nav className="nav">
                  <a className="nav-link" href="#datatable" data-toggle="scroll-to">
                    Datatable
                  </a>
                </nav>
              </NavScrollTo>

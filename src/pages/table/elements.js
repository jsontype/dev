...
function TableElements() {
  ...
  useEffect(() => {
    ...
    fetch('/assets/data/table/element-code-1..json', option)
    ...
    fetch('/assets/data/table/element-code-2..json', option)
      .then(function (response) {
        return response.text()
      })
      .then(html => {
    ...
    fetch('/assets/data/table/element-code-3..json', option)
      .then(function (response) {
        return response.text()
      })
      .then(html => {
    ...
    fetch('/assets/data/table/element-code-4..json', option)
      .then(function (response) {
        return response.text()
      })
      .then(html => {
    ...
    fetch('/assets/data/table/element-code-5..json', option)
      .then(function (response) {
        return response.text()
      })
      .then(html => {
    ...
    fetch('/assets/data/table/element-code-6..json', option)
      .then(function (response) {
        return response.text()
      })
      .then(html => {
    ...
    fetch('/assets/data/table/element-code-7..json', option)
      .then(function (response) {
        return response.text()
      })
      .then(html => {
    ...
    fetch('/assets/data/table/element-code-8..json', option)
      .then(function (response) {
        return response.text()
      })
      .then(html => {
    ...
    fetch('/assets/data/table/element-code-9..json', option)
      .then(function (response) {
        return response.text()
      })
      .then(html => {
    ...
    fetch('/assets/data/table/element-code-10..json', option)
      .then(function (response) {
        return response.text()
      })
      .then(html => {
        ...
        <div className="col-xl-10">
          <div className="row">
            <div className="col-xl-9">
              ...
              <div id="basicTable" className="mb-5">
                ...
                <p>
                  ...
                  Bootstrap. You can also invert the colors—with light text on dark backgrounds—with{' '}
              ...
              <div id="responsiveTables" className="mb-5">
                ...
                <p>
                  ...
                  table responsive across all viewports by wrapping a <code>.table</code> with{' '}
                  <code>.table-responsive</code>. Or, pick a maximum breakpoint with which to have a
                  responsive table up to by using <code>.table-responsive(-sm|-md|-lg|-xl)</code>.
                </p>
                <Card>
                  <CardBody>
            ...
            <div className="col-xl-3">
              <NavScrollTo>
                <nav className="nav">
                  <a className="nav-link" href="#basicTable" data-toggle="scroll-to">
                    Basic table
                  </a>
                  <a className="nav-link" href="#tableHeadOptions" data-toggle="scroll-to">
                    Table head options
                  </a>
                  <a className="nav-link" href="#stripedRows" data-toggle="scroll-to">
                    Striped rows
                  </a>
                  <a className="nav-link" href="#borderedTable" data-toggle="scroll-to">
                    Bordered table
                  </a>
                  <a className="nav-link" href="#borderlessTable" data-toggle="scroll-to">
                    Borderless table
                  </a>
                  <a className="nav-link" href="#hoverableRows" data-toggle="scroll-to">
                    Hoverable rows
                  </a>
                  <a className="nav-link" href="#smallTable" data-toggle="scroll-to">
                    Small table
                  </a>
                  <a className="nav-link" href="#contextualClasses" data-toggle="scroll-to">
                    Contextual classes
                  </a>
                  <a className="nav-link" href="#captions" data-toggle="scroll-to">
                    Captions
                  </a>
                  <a className="nav-link" href="#responsiveTables" data-toggle="scroll-to">
                    Responsive tables
                  </a>
                </nav>
              </NavScrollTo>

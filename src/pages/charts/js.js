        ...
        <div className="col-xl-10">
          <div className="row">
            ...
            <div className="col-xl-3">
              <NavScrollTo>
                <nav className="nav">
                  <a className="nav-link" href="#chartJs" data-toggle="scroll-to">
                    Chart.js
                  </a>
                  <a className="nav-link" href="#chartJsLineChart" data-toggle="scroll-to">
                    {' '}
                    - line chart
                  </a>
                  <a className="nav-link" href="#chartJsBarChart" data-toggle="scroll-to">
                    {' '}
                    - bar chart
                  </a>
                  <a className="nav-link" href="#chartJsRadarChart" data-toggle="scroll-to">
                    {' '}
                    - radar chart
                  </a>
                  <a className="nav-link" href="#chartJsPolarAreaChart" data-toggle="scroll-to">
                    {' '}
                    - polar area chart
                  </a>
                  <a className="nav-link" href="#chartJsPieChart" data-toggle="scroll-to">
                    {' '}
                    - pie chart
                  </a>
                  <a className="nav-link" href="#chartJsDoughnutChart" data-toggle="scroll-to">
                    {' '}
                    - doughnut chart
                  </a>
                </nav>

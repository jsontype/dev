...
function ChartApex() {
  ...
  var radarChartData = [{ name: 'Series 1', data: [20, 100, 40, 30, 50, 80, 33] }]
  ...
  function getLineChartOptions() {
    ...
    return {
      ...
      title: {
        ...
        align: 'center',
        style: { fontSize: '14px', fontWeight: 'bold', fontFamily: themeFont, color: inverse },
      },
      ...
      grid: {
        ...
        row: { colors: ['rgba(' + inverseRgb + ', .25)', 'transparent'], opacity: 0.5 },
      },
      markers: { size: 4 },
      xaxis: {
          ...
          <div className="row">
            <div className="col-xl-9">
              ...
              <div id="apexChart">
                <h4>Basic Example</h4>
                <p>
                  Apexcharts.js is a modern javaScript charting library to build interactive charts
                  and visualizations with simple API. Please read the{' '}
            ...
            <div className="col-xl-3">
              <NavScrollTo>
                <nav className="nav">
                  <a className="nav-link" href="#apexChart" data-toggle="scroll-to">
                    Apexcharts.js
                  </a>
                  <a className="nav-link" href="#apexChartLineChart" data-toggle="scroll-to">
                    {' '}
                    - line chart
                  </a>
                  <a className="nav-link" href="#apexChartColumnChart" data-toggle="scroll-to">
                    {' '}
                    - column chart
                  </a>
                  <a className="nav-link" href="#apexChartAreaChart" data-toggle="scroll-to">
                    {' '}
                    - area chart
                  </a>
                  <a className="nav-link" href="#apexChartBarChart" data-toggle="scroll-to">
                    {' '}
                    - bar chart
                  </a>
                  <a className="nav-link" href="#apexChartMixedChart" data-toggle="scroll-to">
                    {' '}
                    - mixed chart
                  </a>
                  <a className="nav-link" href="#apexChartCandlestickChart" data-toggle="scroll-to">
                    {' '}
                    - candlestick chart
                  </a>
                  <a className="nav-link" href="#apexChartBubbleChart" data-toggle="scroll-to">
                    {' '}
                    - bubble chart
                  </a>
                  <a className="nav-link" href="#apexChartScatterChart" data-toggle="scroll-to">
                    {' '}
                    - scatter chart
                  </a>
                  <a className="nav-link" href="#apexChartHeatmapChart" data-toggle="scroll-to">
                    {' '}
                    - heatmap chart
                  </a>
                  <a className="nav-link" href="#apexChartPieChart" data-toggle="scroll-to">
                    {' '}
                    - pie chart
                  </a>
                  <a className="nav-link" href="#apexChartRadialBarChart" data-toggle="scroll-to">
                    {' '}
                    - radial bar chart
                  </a>
                  <a className="nav-link" href="#apexChartRadarChart" data-toggle="scroll-to">
                    {' '}
                    - radar chart
                  </a>
                </nav>

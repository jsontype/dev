...
function PosCustomerOrder() {
  ...
  var getTaxesPrice = () => {
    ...
    if (orderData) {
      for (var i = 0; i < orderData.length; i++) {
        value += parseFloat(orderData[i].price) * parseInt(orderData[i].quantity) * 0.06
      }
    }
    return value.toFixed(2)
  }
          ...
          <div className="pos-sidebar" id="pos-sidebar">
            <div className="h-100 d-flex flex-column p-0">
              <div className="pos-sidebar-header">
                ...
                <div className="icon">
                  <img src="/assets/img/pos/icon-table-black.svg" className="invert-dark" alt="" />
                </div>
                <div className="title">
                  Table {tableData && tableData.tableNo && tableData.tableNo}
                </div>
                <div className="order">
                  Order: <b>{tableData && tableData.orderNo && tableData.orderNo}</b>
                </div>
              </div>

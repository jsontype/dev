                              ...
                              {table.reservation.length > 0 ? (
                                table.reservation.map((reservation, index) => (
                                  <div
                                    className={
                                      'booking' +
                                      (checkSameHour(reservation.time) ? ' highlight' : '')
                                    }
                                    key={index}
                                  >
                                    ...
                                    <div
                                      className={
                                        'status ' + getStatus(reservation.time, reservation.text)
                                      }
                                    >
                                      {reservation.text && <i className="fa fa-circle"></i>}
                                    </div>
                                  </div>
                                ))
                              ) : (
            ...
            <Card>
              <CardBody className="p-0">
                ...
                <div className="modal-footer">
                  <button className="btn btn-default w-100px" data-bs-dismiss="modal">
                    Cancel
                  </button>

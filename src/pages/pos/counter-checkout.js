...
function PosCounterCheckout() {
  ...
  useEffect(() => {
    ...
    fetch('/assets/data/pos/counter-checkout..json', option)
      .then(res => res.json())
      .then(result => {
        setTableData(result)
      })
  ...
  return (
    <Card
      className={
        'pos pos-vertical ' + (posMobileSidebarToggled ? 'pos-mobile-sidebar-toggled' : '')
      }
      id="pos"
    >
            ...
            <div className="pos-container">
                      ...
                      tableData.map((table, index) => (
                        <div className="col-xl-3 col-lg-4 col-md-6 pb-3" key={index}>
                          <Card
                            className={
                              'pos-checkout-table' +
                              (selectedTable && table.tableNo === selectedTable.tableNo
                                ? ' selected'
                                : '') +
                          ...
                          >
                            <a
                              ...
                              onClick={event => toggleMobileSidebar(event, table)}
                            >
                              ...
                              <div className="pos-checkout-table-info small">
                                ...
                                <div className="row">
                                  ...
                                  <div className="col-6 d-flex justify-content-center">
                                    ...
                                    <div
                                      className={
                                        'w-60px' + (table.status === 'Paid' ? ' text-success' : '')
                                      }
                                    >
              ...
              <div className="pos-sidebar" id="pos-sidebar">
                <div className="pos-sidebar-header">
                  ...
                  <div className="title">
                    Table {selectedTable && selectedTable.tableNo ? selectedTable.tableNo : '-'}
                  </div>
                  <div className="order">
                    Order:{' '}
                    <b className="text-theme">
                      #{selectedTable && selectedTable.orderNo ? selectedTable.orderNo : '-'}
                    </b>
                  </div>
                </div>
                <hr className="m-0" />

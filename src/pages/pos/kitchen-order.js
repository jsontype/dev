          ...
          <div className="logo">
            <Link to="/pos/counter-checkout" href="pos_counter_checkout.html">
              <div className="logo-img">
                <i className="bi bi-x-diamond" style={{ fontSize: '1.5rem' }}></i>
              </div>
              ...
              orderData.map((order, index) => (
                <div className="pos-task" key={index}>
                  <div className="pos-task-info">
                    ...
                    {order.orderTime && (
                      <div className={order.urgent ? 'text-danger fw-bold' : ''}>
                  ...
                  <div className="col-lg-3">
                    <div className="pos-task-product">
                      <div className="pos-task-product-img">
                        <div
                          className="cover"
                          style={{ backgroundImage: 'url(/assets/img/pos/product-11.jpg)' }}
                        ></div>
                      </div>
                      <div className="pos-task-product-info">
                        <div className="flex-1">
                  ...
                  <div className="col-lg-3">
                    <div className="pos-task-product completed">
                      <div className="pos-task-product-img">
                        <div
                          className="cover"
                          style={{ backgroundImage: 'url(/assets/img/pos/product-12.jpg)' }}
                        ></div>
                        <div className="caption">
                          <div>Completed</div>
                        </div>
                      ...
                      <div className="pos-task-product-action">
                        ...
                        <a href="#/" className="btn btn-outline-default disabled">
                          Cancel
                        </a>
                      </div>
                    </div>
                  ...
                  <div className="col-lg-3">
                    <div className="pos-task-product completed">
                      <div className="pos-task-product-img">
                        <div
                          className="cover"
                          style={{ backgroundImage: 'url(/assets/img/pos/product-7.jpg)' }}
                        ></div>
                        <div className="caption">
                          <div>Completed</div>
                        </div>
                  ...
                  <div className="col-lg-3">
                    <div className="pos-task-product completed">
                      <div className="pos-task-product-img">
                        <div
                          className="cover"
                          style={{ backgroundImage: 'url(/assets/img/pos/product-2.jpg)' }}
                        ></div>
                        <div className="caption">
                          <div>Completed</div>
                        </div>
                  ...
                  <div className="col-lg-3">
                    <div className="pos-task-product completed">
                      <div className="pos-task-product-img">
                        <div
                          className="cover"
                          style={{ backgroundImage: 'url(/assets/img/pos/product-10.jpg)' }}
                        ></div>
                        <div className="caption">
                          <div>Completed</div>
                        </div>
                  ...
                  <div className="col-lg-3">
                    <div className="pos-task-product completed">
                      <div className="pos-task-product-img">
                        <div
                          className="cover"
                          style={{ backgroundImage: 'url(/assets/img/pos/product-8.jpg)' }}
                        ></div>
                        <div className="caption">
                          <div>Completed</div>
                        </div>
                  ...
                  <div className="col-lg-3">
                    <div className="pos-task-product completed">
                      <div className="pos-task-product-img">
                        <div
                          className="cover"
                          style={{ backgroundImage: 'url(/assets/img/pos/product-13.jpg)' }}
                        ></div>
                        <div className="caption">
                          <div>Completed</div>
                        </div>
                  ...
                  <div className="col-lg-3">
                    <div className="pos-task-product completed">
                      <div className="pos-task-product-img">
                        <div
                          className="cover"
                          style={{ backgroundImage: 'url(/assets/img/pos/product-9.jpg)' }}
                        ></div>
                        <div className="caption">
                          <div>Completed</div>
                        </div>
                  ...
                  <div className="col-lg-3">
                    <div className="pos-task-product completed">
                      <div className="pos-task-product-img">
                        <div
                          className="cover"
                          style={{ backgroundImage: 'url(/assets/img/pos/product-4.jpg)' }}
                        ></div>
                        <div className="caption">
                          <div>Completed</div>
                        </div>
                  ...
                  <div className="col-lg-3">
                    <div className="pos-task-product completed">
                      <div className="pos-task-product-img">
                        <div
                          className="cover"
                          style={{ backgroundImage: 'url(/assets/img/pos/product-6.jpg)' }}
                        ></div>
                        <div className="caption">
                          <div>Completed</div>
                        </div>
                  ...
                  <div className="col-lg-3">
                    <div className="pos-task-product completed">
                      <div className="pos-task-product-img">
                        <div
                          className="cover"
                          style={{ backgroundImage: 'url(/assets/img/pos/product-5.jpg)' }}
                        ></div>
                        <div className="caption">
                          <div>Completed</div>
                        </div>

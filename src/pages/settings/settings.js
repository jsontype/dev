            ...
            <div className="row">
              <div className="col-xl-9">
                ...
                <div id="notifications" className="mb-5">
                  <h4>
                    <i className="far fa-bell fa-fw text-theme"></i> Notifications
                  </h4>
                ...
                <div id="privacyAndSecurity" className="mb-5">
                  <h4>
                    <i className="far fa-copyright fa-fw text-theme"></i> Privacy and security
                  </h4>
                ...
                <div id="payment" className="mb-5">
                  <h4>
                    <i className="far fa-credit-card fa-fw text-theme"></i> Payment
                  </h4>
                ...
                <div id="shipping" className="mb-5">
                  <h4>
                    <i className="far fa-paper-plane fa-fw text-theme"></i> Shipping
                  </h4>
                    ...
                    <div className="list-group list-group-flush">
                      <div className="list-group-item d-flex align-items-center">
                        <div className="flex-1 text-break">
                          ...
                          <div className="text-inverse text-opacity-50">Local, Domestic</div>
                        </div>
                        <div>
                          <a
                            href="#modalEdit"
                ...
                <div id="mediaAndFiles" className="mb-5">
                  <h4>
                    <i className="far fa-images fa-fw text-theme"></i> Media and Files
                  </h4>
                    ...
                    <div className="list-group list-group-flush">
                      <div className="list-group-item d-flex align-items-center">
                        <div className="flex-1 text-break">
                          ...
                          <div className="text-inverse text-opacity-50">.png, .jpg, .gif, .mp4</div>
                        </div>
                        <div>
                          <a
                            href="#modalEdit"
                ...
                <div id="languages" className="mb-5">
                  <h4>
                    <i className="fa fa-language fa-fw text-theme"></i> Languages
                  </h4>
                  ...
                  <Card>
                    <div className="list-group list-group-flush">
                      <div className="list-group-item d-flex align-items-center">
                        <div className="flex-1 text-break">
                          <div>Web storage</div>
                          <div className="text-inverse text-opacity-50">40.8gb / 100gb</div>
                        </div>
                        <div>
                          <a
                            href="#modalEdit"
                      ...
                      <div className="list-group-item d-flex align-items-center">
                        <div className="flex-1 text-break">
                          ...
                          <div className="text-inverse text-opacity-50">Unlimited</div>
                        </div>
                      </div>
                      <div className="list-group-item d-flex align-items-center">
                        <div className="flex-1 text-break">
                          <div>Database</div>
                          <div className="text-inverse text-opacity-50">MySQL version 8.0.19</div>
                        </div>
                        <div>
                          <a
                            href="#modalEdit"
                ...
                <div id="resetSettings" className="mb-5">
                  <h4>
                    <i className="fa fa-redo fa-fw text-theme"></i> Reset settings
                  </h4>
                  ...
                  <Card>
                    <div className="list-group list-group-flush">
                      <div className="list-group-item d-flex align-items-center">
                        ...
                        <div>
                          <a href="#/" className="btn btn-outline-default w-100px">
                            Reset
                          </a>
                        </div>
                      </div>
              ...
              <div className="col-xl-3">
                <NavScrollTo>
                  <nav className="nav">
                    <a className="nav-link" href="#general" data-toggle="scroll-to">
                      General
                    </a>
                    <a className="nav-link" href="#notifications" data-toggle="scroll-to">
                      Notifications
                    </a>
                    <a className="nav-link" href="#privacyAndSecurity" data-toggle="scroll-to">
                    ...
                    <a className="nav-link" href="#mediaAndFiles" data-toggle="scroll-to">
                      Media and Files
                    </a>
                    ...
                    <a className="nav-link" href="#resetSettings" data-toggle="scroll-to">
                      Reset settings
                    </a>
                  </nav>
                </NavScrollTo>
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              ...
              <div className="alert bg-inverse bg-opacity-15">
                <b>Please note:</b>
                If you change your name, you can't change it again for 60 days. Don't add any
                unusual capitalization, punctuation, characters or random words.
            ...
            <div className="modal-footer">
              <button type="button" className="btn btn-outline-default" data-bs-dismiss="modal">
                Close
              </button>

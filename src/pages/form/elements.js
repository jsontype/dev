        ...
        <div className="col-xl-10">
          <div className="row">
            <div className="col-xl-9">
              ...
              <div id="formControls" className="mb-5">
                ...
                <p>
                  ...
                  <code>&lt;select&gt;</code>s, and <code>&lt;textarea&gt;</code>s—are styled with
                  the .form-control class. Included are styles for general appearance, focus state,
                  sizing, and more. Please read the{' '}
                  <a
                    ...
                    <form>
                      <div className="row">
                        <div className="col-xl-6">
                          ...
                          <div className="form-group mb-3">
                            <label className="form-label" htmlFor="exampleFormControlFile1">
                              File input
                            </label>
                            <input
                              type="file"
              ...
              <div id="readOnly" className="mb-5">
                ...
                <p>
                  ...
                  input’s value. Read-only inputs appear lighter (just like disabled inputs), but
              ...
              <div id="readOnlyPlainText" className="mb-5">
                ...
                <p>
                  ...
                  styled as plain text, use the .form-control-plaintext class to remove the default
              ...
              <div id="rangeInputs" className="mb-5">
                <h4>Range inputs</h4>
                <p>
                  Set horizontally scrollable range inputs using <code>.form-range</code>.
                </p>
                <Card>
                  <CardBody>
                    <div className="row mb-n3">
                      <div className="col-xl-6">
                        <div className="form-group mb-3">
                          <label htmlFor="formControlRange" className="form-label">
                            Example range input
                          </label>
              ...
              <div id="checkboxes" className="mb-5">
                <h4>Checkboxes</h4>
                <p>
                  Default checkboxes are improved upon with the help of <code>.form-check</code>, a
              ...
              <div id="radios" className="mb-5">
                <h4>Radios</h4>
                <p>
                  Default radios are improved upon with the help of <code>.form-check</code>, a
                  single class for both input types that improves the layout and behavior of their
                  HTML elements. You can use Bootstrap custom radio for styled radio button.
                </p>
                <Card>
                  <CardBody>
                    <div className="row mb-n3">
              ...
              <div id="switches" className="mb-5">
                ...
                <p>
                  ...
                  <code>.form-switch</code> class to render a toggle switch. Switches also support
              ...
              <div id="selectMenu" className="mb-5">
                ...
                <p>
                  ...
                  custom styles. Custom styles are limited to the &lt;select&gt;’s initial
              ...
              <div id="fileBrowser" className="mb-5">
                <h4>File browser</h4>
                <p>
                  The file input is the most gnarly of the bunch and requires additional JavaScript
                  if you’d like to hook them up with functional Choose file… and selected file name
                  text.
                </p>
                <Card>
                  <CardBody>
              ...
              <div id="formGrid" className="mb-5">
                <h4>Form grid</h4>
                <p>
                  More complex forms can be built using bootstrap grid classes. Use these for form
              ...
              <div id="helpText" className="mb-5">
                <h4>Help text</h4>
                <p>
                  Block-level help text in forms can be created using <code>.form-text</code>.
                  Inline help text can be flexibly implemented using any inline HTML element and
                  utility classes like <code>.text-muted</code>.
                </p>
                <Card>
                  <CardBody>
              ...
              <div id="inputGroup" className="mb-5">
                ...
                <p>
                  ...
                  both sides of an input. Remember to place <code>&lt;label&gt;</code> outside the
                  input group.
                </p>
                <Card>
                  <CardBody>
              ...
              <div id="validation" className="mb-5">
                ...
                <p>
                  ...
                  Choose from the browser default validation feedback, or implement custom messages
                    ...
                    <form className="was-validated">
                      <div className="row mb-n3">
                        <div className="col-md-6 mb-3">
                          <label htmlFor="validationValidInput" className="form-label">
                            Valid input
                          </label>
                          <input
                            type="text"
                        ...
                        <div className="col-md-6 mb-3">
                          <label htmlFor="validationInvalidInput" className="form-label">
                            Invalid input
                          </label>
                          <input
                            type="text"
                        ...
                        <div className="col-md-6 mb-3">
                          <label htmlFor="validationInvalidInputGroup" className="form-label">
                            Input group
                          </label>
                        ...
                        <div className="col-md-6 mb-3">
                          <label htmlFor="validationSelectInvalid" className="form-label">
                            Select dropdown
                          </label>
                          <select
            ...
            <div className="col-xl-3">
              <NavScrollTo>
                <nav className="nav">
                  <a className="nav-link" href="#formControls" data-toggle="scroll-to">
                    Form controls
                  </a>
                  <a className="nav-link" href="#sizing" data-toggle="scroll-to">
                    Sizing
                  </a>
                  <a className="nav-link" href="#readOnly" data-toggle="scroll-to">
                    Readonly
                  </a>
                  <a className="nav-link" href="#readOnlyPlainText" data-toggle="scroll-to">
                    Readonly plain text
                  </a>
                  <a className="nav-link" href="#rangeInputs" data-toggle="scroll-to">
                    Range inputs
                  </a>
                  <a className="nav-link" href="#checkboxes" data-toggle="scroll-to">
                    Checkboxes
                  </a>
                  <a className="nav-link" href="#radios" data-toggle="scroll-to">
                    Radios
                  </a>
                  <a className="nav-link" href="#switches" data-toggle="scroll-to">
                    Switches
                  </a>
                  <a className="nav-link" href="#selectMenu" data-toggle="scroll-to">
                    Select menu
                  </a>
                  <a className="nav-link" href="#fileBrowser" data-toggle="scroll-to">
                    File browser
                  </a>
                  <a className="nav-link" href="#formGrid" data-toggle="scroll-to">
                    Form grid
                  </a>
                  <a className="nav-link" href="#helpText" data-toggle="scroll-to">
                    Help text
                  </a>
                  <a className="nav-link" href="#inputGroup" data-toggle="scroll-to">
                    Input group
                  </a>
                  <a className="nav-link" href="#validation" data-toggle="scroll-to">
                    Validation
                  </a>
                </nav>
              </NavScrollTo>

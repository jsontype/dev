          ...
          <div className="row">
            <div className="col-xl-9">
              ...
              <div id="wizardLayout1" className="mb-5">
                ...
                <p>
                  Wizard layout include the number of step and text. Please do note that all the
                  wizard is for uxui ONLY but do not include any javascript or backend logic.
                </p>
                <Card>
                  <CardBody>
            ...
            <div className="col-xl-3">
              <NavScrollTo>
                <nav className="nav">
                  <a className="nav-link" href="#wizardLayout1" data-toggle="scroll-to">
                    Wizard layout 1
                  </a>
                  <a className="nav-link" href="#wizardLayout2" data-toggle="scroll-to">
                    Wizard layout 2
                  </a>
                  <a className="nav-link" href="#wizardLayout3" data-toggle="scroll-to">
                    Wizard layout 3
                  </a>
                </nav>
              </NavScrollTo>

...
function FormPlugins() {
  ...
  const [dateRangeCurrentWeek, setDateRangeCurrentWeek] = useState(
    Moment().subtract(7, 'days').format('D MMM YYYY') + ' - ' + Moment().format('D MMM YYYY'),
  )
          ...
          <div className="row">
            <div className="col-xl-9">
              ...
              <div id="reactDatetime" className="mb-5">
                ...
                <p>
                  A date and time picker in the same React.js component. It can be used as a
                  datepicker, timepicker or both at the same time. It is highly customizable and it
                  even allows to edit date's milliseconds. Please read the{' '}
                  <a
              ...
              <div id="reactSelect" className="mb-5">
                ...
                <p>
                  ...
                  autocomplete, async and creatable support. Please read the{' '}
              ...
              <div id="reactDatepicker" className="mb-5">
                ...
                <p>
                  A simple and reusable datepicker component for React. Please read the{' '}
              ...
              <div id="reactInputMask" className="mb-5">
                ...
                <p>
                  Input masking component for React. Made with attention to UX. Please read the{' '}
                  <a
              ...
              <div id="reactColor" className="mb-5">
                ...
                <p>
                  ...
                  Material Design & more. Please read the{' '}
                  <a
                    ...
                    <form>
                      <div className="row">
                        <div className="col-xl-6">
                          <div className="mb-3">
                            <label className="form-label">
                              Sketch Type Colorpicker <span className="text-danger">*</span>
                            </label>
                        ...
                        <div className="col-xl-6">
                          <div className="mb-3">
                            <label className="form-label">
                              Chrome Type Colorpicker <span className="text-danger">*</span>
                            </label>
                            <div className="input-group">
                              <input
                                type="text"
              ...
              <div id="reactDateRangePicker" className="mb-5">
                ...
                <p>
                  A date/time picker for react (using bootstrap). Please read the{' '}
                  <a
            ...
            <div className="col-xl-3">
              <NavScrollTo>
                <nav className="nav text-nowrap">
                  <a className="nav-link" href="#reactDatetime" data-toggle="scroll-to">
                    React Datetime
                  </a>
                  <a className="nav-link text-nowrap" href="#reactSelect" data-toggle="scroll-to">
                    React Select
                  </a>
                  <a className="nav-link" href="#reactDatepicker" data-toggle="scroll-to">
                    React Datepicker
                  </a>
                  <a className="nav-link" href="#reactInputMask" data-toggle="scroll-to">
                    React Input Mask
                  </a>
                  <a className="nav-link" href="#reactColor" data-toggle="scroll-to">
                    React Color
                  </a>
                  <a className="nav-link" href="#reactTagInputComponent" data-toggle="scroll-to">
                    React Tag Input Component
                  </a>
                  <a className="nav-link" href="#reactQuill" data-toggle="scroll-to">
                    React Quill
                  </a>
                  <a className="nav-link" href="#reactDateRangePicker" data-toggle="scroll-to">

...
function UiCard() {
  ...
  useEffect(() => {
    ...
    fetch('/assets/data/ui/card-code-1..json', option)
    ...
    fetch('/assets/data/ui/card-code-2..json', option)
      .then(function (response) {
        return response.text()
      })
      .then(html => {
    ...
    fetch('/assets/data/ui/card-code-3..json', option)
      .then(function (response) {
        return response.text()
      })
      .then(html => {
    ...
    fetch('/assets/data/ui/card-code-4..json', option)
      .then(function (response) {
        return response.text()
      })
      .then(html => {
    ...
    fetch('/assets/data/ui/card-code-5..json', option)
      .then(function (response) {
        return response.text()
      })
      .then(html => {
    ...
    fetch('/assets/data/ui/card-code-6..json', option)
      .then(function (response) {
        return response.text()
      })
      .then(html => {
    ...
    fetch('/assets/data/ui/card-code-7..json', option)
      .then(function (response) {
        return response.text()
      })
      .then(html => {
    ...
    fetch('/assets/data/ui/card-code-8..json', option)
      .then(function (response) {
        return response.text()
      })
      .then(html => {
    ...
    fetch('/assets/data/ui/card-code-9..json', option)
      .then(function (response) {
        return response.text()
      })
      .then(html => {
    ...
    fetch('/assets/data/ui/card-code-10..json', option)
      .then(function (response) {
        return response.text()
      })
      .then(html => {
        ...
        <div className="col-xl-10">
          <div className="row">
            <div className="col-xl-9">
              ...
              <div id="basicUsage" className="mb-5">
                ...
                <p>
                  ...
                  multiple variants and options. Please read the{' '}
                  <a
                ...
                <Card>
                  <CardBody>
                    <div className="row">
                      ...
                      <div className="col-xl-6">
                        <Card>
                          <CardHeader className="fw-bold small">CARD WITH LIST GROUP</CardHeader>
              ...
              <div id="fullscreen" className="mb-5">
                ...
                <p>
                  ...
                  <code>data-toggle="card-expand"</code> to any link or button to trigger the
                  maximize or minimize the card element
                </p>
                <Card>
                  <div className="row">
              ...
              <div id="images" className="mb-5">
                <h4>Images</h4>
                <p>
                  Cards include a few options for working with images. Choose from appending “image
                  caps” at either end of a card, overlaying images with card content, or simply
              ...
              <div id="cardGroups" className="mb-5">
                ...
                <p>
                  ...
                  height columns. Card groups use <code>display: flex;</code> to achieve their
                  uniform sizing.
                </p>
                <Card>
                  <CardBody>
              ...
              <div id="cardColumns" className="mb-5">
                <h4>Card columns</h4>
                <p>
                  In <code>v5</code>, cards can be organized into Masonry-like columns with masonry
                  javascript included.
                </p>
                <Card>
                  <CardBody>
            ...
            <div className="col-xl-3">
              <NavScrollTo>
                <nav className="nav">
                  <a className="nav-link" href="#basicUsage" data-toggle="scroll-to">
                    Basic usage
                  </a>
                  <a className="nav-link" href="#fullscreen" data-toggle="scroll-to">
                    Fullscreen (extended feature)
                  </a>
                  <a className="nav-link" href="#sizing" data-toggle="scroll-to">
                    Sizing
                  </a>
                  <a className="nav-link" href="#navigation" data-toggle="scroll-to">
                    Navigation
                  </a>
                  <a className="nav-link" href="#images" data-toggle="scroll-to">
                    Images
                  </a>
                  <a className="nav-link" href="#horizontal" data-toggle="scroll-to">
                    Horizontal
                  </a>
                  <a className="nav-link" href="#cardStyles" data-toggle="scroll-to">
                    Card styles
                  </a>
                  <a className="nav-link" href="#cardGroups" data-toggle="scroll-to">
                    Card groups
                  </a>
                  <a className="nav-link" href="#gridCards" data-toggle="scroll-to">
                    Grid cards
                  </a>
                  <a className="nav-link" href="#cardColumns" data-toggle="scroll-to">
                    Card columns
                  </a>
                </nav>
              </NavScrollTo>

...
function UiBootstrap() {
  ...
  useEffect(() => {
    ...
    fetch('/assets/data/ui/bootstrap-code-1..json', option)
    ...
    fetch('/assets/data/ui/bootstrap-code-2..json', option)
      .then(function (response) {
        return response.text()
      })
      .then(html => {
    ...
    fetch('/assets/data/ui/bootstrap-code-3..json', option)
      .then(function (response) {
        return response.text()
      })
      .then(html => {
    ...
    fetch('/assets/data/ui/bootstrap-code-4..json', option)
      .then(function (response) {
        return response.text()
      })
      .then(html => {
    ...
    fetch('/assets/data/ui/bootstrap-code-5..json', option)
      .then(function (response) {
        return response.text()
      })
      .then(html => {
    ...
    fetch('/assets/data/ui/bootstrap-code-6..json', option)
      .then(function (response) {
        return response.text()
      })
      .then(html => {
    ...
    fetch('/assets/data/ui/bootstrap-code-7..json', option)
      .then(function (response) {
        return response.text()
      })
      .then(html => {
    ...
    fetch('/assets/data/ui/bootstrap-code-8..json', option)
      .then(function (response) {
        return response.text()
      })
      .then(html => {
    ...
    fetch('/assets/data/ui/bootstrap-code-9..json', option)
      .then(function (response) {
        return response.text()
      })
      .then(html => {
    ...
    fetch('/assets/data/ui/bootstrap-code-10..json', option)
      .then(function (response) {
        return response.text()
      })
      .then(html => {
    ...
    fetch('/assets/data/ui/bootstrap-code-11..json', option)
      .then(function (response) {
        return response.text()
      })
      .then(html => {
    ...
    fetch('/assets/data/ui/bootstrap-code-12..json', option)
      .then(function (response) {
        return response.text()
      })
      .then(html => {
          ...
          <div className="row">
            <div className="col-xl-9">
              ...
              <div id="alert" className="mb-5">
                <h4>Alerts</h4>
                <p>
                  Wrap any text and an optional dismiss button in <code>.alert</code> and one of the
                  four contextual classes for basic alert messages. Please read the{' '}
                  <a
                ...
                <Card>
                  <CardBody>
                    ...
                    <div className="alert alert-secondary">
                      <strong>Secondary Alert!</strong> This alert is not important, but it's
                      beautiful.
                    </div>
              ...
              <div id="breadcrumb" className="mb-5">
                ...
                <p>
                  ...
                  automatically adds separators via CSS. Please read the{' '}
                  <a
                    ...
                    <div id="carouselExample" className="carousel slide" data-ride="carousel">
                      ...
                      <div className="carousel-inner">
                        <div className="carousel-item active">
                          <img
                            src="https://via.placeholder.com/728x400/c9d2e3/212837"
                            alt=""
              ...
              <div id="jumbotron" className="mb-5">
                <h4>Jumbotron</h4>
                <p>
                  Lightweight, flexible component for showcasing hero unit style content by using
                  Bootstrap utilities.
                </p>
                <Card>
                  <CardBody>
                    <div className="p-5 bg-inverse bg-opacity-10 mb-0 rounded-3">
                      ...
                      <a className="btn btn-theme btn-lg" href="#/" role="button">
                        Learn more
                      </a>
                    </div>
                  </CardBody>
              ...
              <div id="mediaObject" className="mb-5">
                <h4>Media Object</h4>
                <p>
                  Media object is created by using Bootstrap utilities class and it is construct
              ...
              <div id="navs" className="mb-5">
                ...
                <p>
                  ...
                  .nav class to the active and disabled states. Swap modifier classes to switch
                  between each style. Please read the{' '}
                  <a
              ...
              <div id="navbar" className="mb-5">
                <h4>Narbar</h4>
                <p>
                  Includes support for branding, navigation, and more, including support for
                  collapse plugin. Please read the{' '}
                  <a
              ...
              <div id="pagination" className="mb-5">
                ...
                <p>
                  ...
                  content exists across multiple pages. Please read the{' '}
                  <a
              ...
              <div id="progress" className="mb-5">
                ...
                <p>
                  ...
                  support for stacked bars, animated backgrounds, and text labels. Please read the{' '}
                  <a
              ...
              <div id="spinners" className="mb-5">
                ...
                <p>
                  ...
                  entirely with HTML, CSS, and no JavaScript. Please read the{' '}
                  <a
            ...
            <div className="col-xl-3">
              <NavScrollTo>
                <nav className="nav">
                  ...
                  <a className="nav-link" href="#breadcrumb" data-toggle="scroll-to">
                    Breadcrumb
                  </a>
                  <a className="nav-link" href="#carousel" data-toggle="scroll-to">
                    Carousel
                  </a>
                  <a className="nav-link" href="#jumbotron" data-toggle="scroll-to">
                    Jumbotron
                  </a>
                  <a className="nav-link" href="#listGroup" data-toggle="scroll-to">
                    List group
                  </a>
                  <a className="nav-link" href="#mediaObject" data-toggle="scroll-to">
                    Media object
                  </a>
                  <a className="nav-link" href="#navs" data-toggle="scroll-to">
                    Navs
                  </a>
                  <a className="nav-link" href="#navbar" data-toggle="scroll-to">
                    Navbar
                  </a>
                  <a className="nav-link" href="#pagination" data-toggle="scroll-to">
                    Pagination
                  </a>
                  <a className="nav-link" href="#progress" data-toggle="scroll-to">
                    Progress
                  </a>
                  <a className="nav-link" href="#spinners" data-toggle="scroll-to">
                    Spinners
                  </a>
                </nav>
              </NavScrollTo>

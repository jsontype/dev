...
function UiTypography() {
  ...
  useEffect(() => {
    ...
    fetch('/assets/data/ui/typography-code-1..json', option)
    ...
    fetch('/assets/data/ui/typography-code-2..json', option)
      .then(function (response) {
        return response.text()
      })
      .then(html => {
    ...
    fetch('/assets/data/ui/typography-code-3..json', option)
      .then(function (response) {
        return response.text()
      })
      .then(html => {
    ...
    fetch('/assets/data/ui/typography-code-4..json', option)
      .then(function (response) {
        return response.text()
      })
      .then(html => {
    ...
    fetch('/assets/data/ui/typography-code-5..json', option)
      .then(function (response) {
        return response.text()
      })
      .then(html => {
    ...
    fetch('/assets/data/ui/typography-code-6..json', option)
      .then(function (response) {
        return response.text()
      })
      .then(html => {
    ...
    fetch('/assets/data/ui/typography-code-7..json', option)
      .then(function (response) {
        return response.text()
      })
      .then(html => {
    ...
    fetch('/assets/data/ui/typography-code-8..json', option)
      .then(function (response) {
        return response.text()
      })
      .then(html => {
    ...
    fetch('/assets/data/ui/typography-code-9..json', option)
      .then(function (response) {
        return response.text()
      })
      .then(html => {
        ...
        <div className="col-xl-10">
          <div className="row">
            <div className="col-xl-9">
              ...
              <div id="headings" className="mb-5">
                ...
                <p>
                  ...
                  for when you want to match the font styling of a heading but cannot use the
                  associated HTML element. Please read the{' '}
                  <a
              ...
              <div id="abbreviations" className="mb-5">
                ...
                <p>
                  ...
                  hover and to users of assistive technologies. Add <code>.initialism</code> to an
              ...
              <div id="blockquotes" className="mb-5">
                ...
                <p>
                  ...
                  <code>&lt;blockquote className="blockquote"&gt;</code> around any HTML as the
                  quote.
                </p>
                <Card>
                  <CardBody>
              ...
              <div id="unstyledList" className="mb-5">
                ...
                <p>
                  ...
                  (immediate children only). This only applies to immediate children list items,
            ...
            <div className="col-xl-3">
              <NavScrollTo>
                <nav className="nav">
                  <a className="nav-link" href="#headings" data-toggle="scroll-to">
                    Headings
                  </a>
                  <a className="nav-link" href="#displayHeadings" data-toggle="scroll-to">
                    Display headings
                  </a>
                  <a className="nav-link" href="#lead" data-toggle="scroll-to">
                    Lead
                  </a>
                  <a className="nav-link" href="#inlineTextElements" data-toggle="scroll-to">
                    Inline text elements
                  </a>
                  <a className="nav-link" href="#abbreviations" data-toggle="scroll-to">
                    Abbreviations
                  </a>
                  <a className="nav-link" href="#blockquotes" data-toggle="scroll-to">
                    Blockquotes
                  </a>
                  <a className="nav-link" href="#unstyledList" data-toggle="scroll-to">
                    Unstyled list
                  </a>
                  <a className="nav-link" href="#inlineList" data-toggle="scroll-to">
                    Inline list
                  </a>
                  <a className="nav-link" href="#descriptionList" data-toggle="scroll-to">
                    Description List
                  </a>
                </nav>
              </NavScrollTo>

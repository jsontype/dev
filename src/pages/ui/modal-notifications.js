...
function UiModalNotifications() {
  ...
  useEffect(() => {
    ...
    fetch('/assets/data/ui/modal-notification-code-1..json', option)
    ...
    fetch('/assets/data/ui/modal-notification-code-2..json', option)
      .then(function (response) {
        return response.text()
      })
      .then(html => {
    ...
    fetch('/assets/data/ui/modal-notification-code-3..json', option)
      .then(function (response) {
        return response.text()
      })
      .then(html => {
    ...
    fetch('/assets/data/ui/modal-notification-code-4..json', option)
      .then(function (response) {
        return response.text()
      })
      .then(html => {
    ...
    fetch('/assets/data/ui/modal-notification-code-5..json', option)
      .then(function (response) {
        return response.text()
      })
      .then(html => {
          ...
          <div className="col-xl-10">
            <div className="row">
              <div className="col-xl-9">
                ...
                <div id="modal" className="mb-5">
                  ...
                  <p>
                    ...
                    lightboxes, user notifications, or completely custom content. Please read the{' '}
                    <a
                ...
                <div id="modalSizes" className="mb-5">
                  ...
                  <p>
                    ...
                    avoid horizontal scrollbars on narrower viewports.
                  </p>
                  <Card>
                    <CardBody>
                      <button
                ...
                <div id="modalCover" className="mb-5">
                  <h4>Modal Cover</h4>
                  <p>
                    Modal cover is an extended feature from Bootstrap modal. It provide the same
                    background color as the modal content. Place a <code>.modal-cover</code> css
                    class on <code>.modal</code> for full cover modal.
                  </p>
                  <Card>
                    <CardBody>
                      <button
                ...
                <div id="toastsNotification" className="mb-5">
                  ...
                  <p>
                    ...
                    customizable alert message. Please read the{' '}
                    <a
                ...
                <div id="toastsContainer" className="mb-5">
                  ...
                  <Card>
                    <CardBody>
                      <a href="#/" className="btn btn-outline-theme me-2" id="showToast1">
                        Show toast 1
                      </a>
                      <a href="#/" className="btn btn-outline-theme" id="showToast2">
                        Show toast 2
                      </a>
                    </CardBody>
                    <div className="hljs-container">
              ...
              <div className="col-xl-3">
                <NavScrollTo>
                  <nav className="nav">
                    <a className="nav-link" href="#modal" data-toggle="scroll-to">
                      Modal
                    </a>
                    <a className="nav-link" href="#modalSizes" data-toggle="scroll-to">
                      Modal Sizes
                    </a>
                    <a className="nav-link" href="#modalCover" data-toggle="scroll-to">
                      Modal Cover
                    </a>
                    <a className="nav-link" href="#toastsNotification" data-toggle="scroll-to">
                      Toasts Notification
                    </a>
                    <a className="nav-link" href="#toastsContainer" data-toggle="scroll-to">
                      Toasts Container
                    </a>
                  </nav>
                </NavScrollTo>
            ...
            <div className="modal-body">
              ...
              <div className="row mb-5">
                ...
                <div className="col-md-3">
                  <button type="button" className="btn btn-outline-theme btn-lg btn-block">
                    Continue
                  </button>
                </div>
              </div>

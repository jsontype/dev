            ...
            <div className="col-xl-9">
              ...
              <div id="tabs" className="mb-5">
                ...
                <p>
                  ...
                  interface. Use them to create tabbable regions with bootstrap tab JavaScript
                  plugin. Please read the{' '}
                  <a
                    ...
                    <ul className="nav nav-tabs">
                      ...
                      <li className="nav-item me-1 dropdown">
                        ...
                        <div className="dropdown-menu">
                          <a href="#dropdown1" className="dropdown-item" data-bs-toggle="tab">
                            @fat
                          </a>
                          <a href="#dropdown2" className="dropdown-item" data-bs-toggle="tab">
                            @mdo
                          </a>
                        </div>
                      </li>
              ...
              <div id="tabsV2" className="mb-5">
                <h4>Tabs v2</h4>
                <p>
                  This is an extended ui layout from default Bootstrap navigation tabs. Add{' '}
                  <code>.nav-tabs-v2</code> to the navigation element in order to activate the v2
                  layout.
                </p>
                <Card>
                  <CardBody className="pt-1">
                    <ul className="nav nav-tabs nav-tabs-v2">
                      <li className="nav-item me-3">
                        <a href="#homev2" className="nav-link active" data-bs-toggle="tab">
                          Home
                        </a>
                      </li>
                      <li className="nav-item me-3">
                        <a href="#profilev2" className="nav-link" data-bs-toggle="tab">
                          Profile
                        </a>
                      </li>
                      <li className="nav-item me-3 dropdown">
                        ...
                        <div className="dropdown-menu">
                          <a href="#dropdown1v2" className="dropdown-item" data-bs-toggle="tab">
                            @fat
                          </a>
                          <a href="#dropdown2v2" className="dropdown-item" data-bs-toggle="tab">
                            @mdo
                          </a>
                        </div>
                      </li>
                      ...
                      <div className="col-xl-6">
                        <Card>
                          <ul className="nav nav-tabs pt-3 px-3">
                            ...
                            <li className="nav-item me-1">
                              <a href="#profileWithCard" className="nav-link" data-bs-toggle="tab">
                                Profile
                              </a>
                            </li>
                          </ul>
                  ...
                  <CardBody>
                    ...
                    <div className="tab-content" id="pills-tabContent">
                      <div className="tab-pane fade show active" id="pills-home">
                        Consequat occaecat ullamco amet non eiusmod nostrud dolore irure incididunt
                        est duis anim sunt officia. Fugiat velit proident aliquip nisi incididunt
                        nostrud exercitation proident est nisi. Irure magna elit commodo anim ex
                        veniam culpa eiusmod id nostrud sit cupidatat in veniam ad. Eiusmod
                        consequat eu adipisicing minim anim aliquip cupidatat culpa excepteur quis.
                      ...
                      <div className="tab-pane fade" id="pills-profile">
                        ...
                        mollit ex. Aute sunt incididunt amet commodo est sint nisi deserunt pariatur
                        do. Aliquip ex eiusmod voluptate exercitation cillum id incididunt elit
                        sunt. Qui minim sit magna Lorem id et dolore velit Lorem amet exercitation
                        duis deserunt. Anim id labore elit adipisicing ut in id occaecat pariatur ut
                        ullamco ea tempor duis.
                      </div>
                      <div className="tab-pane fade" id="pills-contact">
                        Est quis nulla laborum officia ad nisi ex nostrud culpa Lorem excepteur
                        aliquip dolor aliqua irure ex. Nulla ut duis ipsum nisi elit fugiat commodo
                        sunt reprehenderit laborum veniam eu veniam. Eiusmod minim exercitation
                        fugiat irure ex labore incididunt do fugiat commodo aliquip sit id deserunt
                        reprehenderit aliquip nostrud. Amet ex cupidatat excepteur aute veniam
                        incididunt mollit cupidatat esse irure officia elit do ipsum ullamco Lorem.
                        Ullamco ut ad minim do mollit labore ipsum laboris ipsum commodo sunt tempor
                        enim incididunt. Commodo quis sunt dolore aliquip aute tempor irure magna
                        enim minim reprehenderit. Ullamco consectetur culpa veniam sint cillum
                        aliqua incididunt velit ullamco sunt ullamco quis quis commodo voluptate.
                        Mollit nulla nostrud adipisicing aliqua cupidatat aliqua pariatur mollit
              ...
              <div id="accordion" className="mb-5">
                <h4>Accordion</h4>
                <p>
                  Build vertically collapsing accordions in combination with Bootstrap Collapse
                  JavaScript plugin. Please read the{' '}
                  <a
            ...
            <div className="col-xl-3">
              <NavScrollTo>
                <nav className="nav">
                  ...
                  <a className="nav-link" href="#tabsV2" data-toggle="scroll-to">
                    Tabs v2
                  </a>
                  <a className="nav-link" href="#tabsWithCard" data-toggle="scroll-to">
                    Tabs with card
                  </a>
                  <a className="nav-link" href="#pills" data-toggle="scroll-to">
                    Pills
                  </a>
                  <a className="nav-link" href="#accordion" data-toggle="scroll-to">
                    Accordion
                  </a>
                </nav>
              </NavScrollTo>

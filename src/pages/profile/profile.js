          ...
          <div className="profile-container">
            <div className="profile-sidebar">
              <div className="desktop-sticky-top">
                ...
                <p>
                  Principal UXUI Design & Brand Architecture for HUD. Creator of SeanTheme. Bringing
                  the world closer together. Studied Computer Science and Psychology at Harvard
                  University.
                </p>
                <div className="mb-1">
                  <i className="fa fa-map-marker-alt fa-fw text-inverse text-opacity-50"></i> New
                  York, NY
                </div>
                <div className="mb-3">
                              ...
                              <div className="flex-fill ps-2">
                                <div className="position-relative d-flex align-items-center">
                                  ...
                                  <div className="position-absolute end-0 text-center">
                                    <a href="#/" className="text-inverse text-opacity-50 me-2">
                                    ...
                                    <a href="#/" className="text-inverse text-opacity-50 me-3">
                        ...
                        <Card className="mb-3">
                          <CardBody>
                            ...
                            <p>
                              ...
                              <br />
                              Quisque sodales urna justo, ac ultrices magna consectetur id.
                              <br />
                              <br />
                              Donec tempor ligula sit amet nunc porta, sed aliquam leo sagittis.
                              <br />
                              Ut auctor congue efficitur. Praesent aliquam pulvinar neque, placerat
                              semper massa elementum et.
                            </p>
                            <hr className="mb-1" />
                              ...
                              <div className="profile-img-list-item main">
                                ...
                                >
                                  <span
                                    className="profile-img-content"
                                    style={{
                                      backgroundImage: 'url(/assets/img/gallery/gallery-6.jpg)',
                                    }}
                                  ></span>
                                </a>
                              </div>
                              <div className="profile-img-list-item">
                                ...
                                >
                                  <span
                                    className="profile-img-content"
                                    style={{
                                      backgroundImage: 'url(/assets/img/gallery/gallery-7.jpg)',
                                    }}
                                  ></span>
                                </a>
                              </div>
                              <div className="profile-img-list-item">
                                ...
                                >
                                  <span
                                    className="profile-img-content"
                                    style={{
                                      backgroundImage: 'url(/assets/img/gallery/gallery-8.jpg)',
                                    }}
                                  ></span>
                                </a>
                              </div>
                              <div className="profile-img-list-item">
                                ...
                                >
                                  <span
                                    className="profile-img-content"
                                    style={{
                                      backgroundImage: 'url(/assets/img/gallery/gallery-9.jpg)',
                                    }}
                                  ></span>
                                </a>
                              </div>
                      ...
                      <div className="tab-pane fade" id="profile-followers">
                        <div className="list-group">
                          <div className="list-group-item d-flex align-items-center">
                            ...
                            <div className="flex-fill px-3">
                              <div>
                                <a href="#/" className="text-inverse fw-bold text-decoration-none">
                                  Ethel Wilkes
                                </a>
                              </div>
                        ...
                        <div className="text-center p-3">
                          <a href="#/" className="text-inverse text-decoration-none">
                              ...
                              <div className="widget-img-list-item">
                                <a href="/assets/img/gallery/gallery-12.jpg" data-lity>
                                  <span
                                    className="img"
                                    style={{
                                      backgroundImage: 'url(/assets/img/gallery/gallery-12.jpg)',
                                    }}
                                  ></span>
                                </a>
                              </div>
                              ...
                              <div className="widget-img-list-item">
                                <a href="/assets/img/gallery/gallery-15.jpg" data-lity>
                                  <span
                                    className="img"
                                    style={{
                                      backgroundImage: 'url(/assets/img/gallery/gallery-15.jpg)',
                                    }}
                                  ></span>
                                </a>
                              </div>
                              <div className="widget-img-list-item">
                                <a href="/assets/img/gallery/gallery-16.jpg" data-lity>
                                  <span
                                    className="img"
                                    style={{
                                      backgroundImage: 'url(/assets/img/gallery/gallery-16.jpg)',
                                    }}
                                  ></span>
                                </a>
                              </div>
                              ...
                              <div className="widget-img-list-item">
                                <a href="/assets/img/gallery/gallery-18.jpg" data-lity>
                                  <span
                                    className="img"
                                    style={{
                                      backgroundImage: 'url(/assets/img/gallery/gallery-18.jpg)',
                                    }}
                                  ></span>
                                </a>
                              </div>
                              <div className="widget-img-list-item">
                                <a href="/assets/img/gallery/gallery-19.jpg" data-lity>
                                  <span
                                    className="img"
                                    style={{
                                      backgroundImage: 'url(/assets/img/gallery/gallery-19.jpg)',
                                    }}
                                  ></span>
                                </a>
                              </div>
                              <div className="widget-img-list-item">
                                <a href="/assets/img/gallery/gallery-20.jpg" data-lity>
                                  <span
                                    className="img"
                                    style={{
                                      backgroundImage: 'url(/assets/img/gallery/gallery-20.jpg)',
                                    }}
                                  ></span>
                                </a>
                              </div>
                      ...
                      <Card className="mb-3">
                        <div className="list-group list-group-flush">
                          ...
                          <div className="list-group-item px-3">
                            ...
                            <div>
                              <small className="text-inverse text-opacity-50">1.89m share</small>
                            </div>
                          </div>
                          <div className="list-group-item px-3">
                            <div className="fw-bold mb-2">#TrollingForGood</div>
                            <div className="fs-13px mb-1">
                              Be a good Troll and spread some positivity on HUD today.
                            </div>
                            <div>
                              <small className="text-inverse text-opacity-50">
                                <i className="fa fa-external-link-square-alt"></i> Promoted by HUD
                                Trolls
                              </small>
                            </div>
                          </div>
                          <div className="list-group-item px-3">
                            ...
                            <div>
                              <small className="text-inverse text-opacity-50">49.3m share</small>
                            </div>
                          </div>
                          <div className="list-group-item px-3">
                            <div className="text-inverse text-opacity-50">
                            ...
                            <div>
                              <small className="text-inverse text-opacity-50">821k share</small>
                            </div>
                          </div>

    ...
    <div>
      ...
      <div className="mb-md-4 mb-3 d-md-flex">
        <div className="dropdown-toggle">
          ...
          >
            <i className="far fa-folder fa-fw fa-lg text-theme me-1"></i> project/hud
          </a>
          <div className="dropdown-menu">
            <a href="#/" className="dropdown-item">
              <i className="far fa-folder fa-fw fa-lg text-theme me-1"></i> project/mobile-app-dev
            </a>
            <a href="#/" className="dropdown-item">
              <i className="far fa-folder fa-fw fa-lg text-theme me-1"></i> project/bootstrap-5
            </a>
            <a href="#/" className="dropdown-item">
              <i className="far fa-folder fa-fw fa-lg text-theme me-1"></i> project/mvc-version
            </a>
            <a href="#/" className="dropdown-item">
              <i className="far fa-folder fa-fw fa-lg text-theme me-1"></i> project/ruby-version
            </a>
          </div>
        </div>
        <div className="ms-md-4 mt-md-0 mt-2">
          <i className="fa fa-code-branch fa-fw fa-lg me-1 text-theme"></i> 1,392 pull request
        </div>
        <div className="ms-md-4 mt-md-0 mt-2">
          <i className="fa fa-users-cog fa-fw fa-lg me-1 text-theme"></i> 52 participant
        </div>
        <div className="ms-md-4 mt-md-0 mt-2">
        ...
        <div className="col-xl-4 col-lg-6">
          <Card className="mb-3">
            <CardHeader className="d-flex align-items-center bg-inverse bg-opacity-10">
              ...
              <a href="#/" className="text-inverse text-opacity-50 text-decoration-none me-3">
                <i className="fa fa-fw fa-redo"></i>
              </a>
              <a href="#/" className="text-inverse text-opacity-50 text-decoration-none">
              ...
              <a href="#/" className="list-group-item list-group-item-action d-flex ps-3">
                ...
                <div className="flex-fill">
                  ...
                  <div className="mb-1 d-flex align-items-center">
                    <div className="me-2">
                      <span className="badge border border-theme text-theme">enhancement</span>
                    </div>
                    ...
                    <div className="collapse show" id="inProgressBoard">
                      <div className="form-check mb-2px">
                        <input
                          ...
                          defaultChecked
                        />
                        <label className="form-check-label small" htmlFor="customCheck4">
                          check all browser compatibility for HTML5 flexbox
                        </label>
                      </div>
                      <div className="form-check mb-2px">
                        <input type="checkbox" className="form-check-input" id="customCheck5" />
                        <label className="form-check-label small" htmlFor="customCheck5">
                  ...
                  <div className="form-group mb-1">
                    <div className="collapse show" id="inProgress2Board">
                      <div className="form-check mb-2px">
                        ...
                        <label className="form-check-label small" htmlFor="customCheck6">
                    ...
                    <div className="collapse show" id="completedBoard">
                      <div className="form-check mb-2px">
                        <input
                          ...
                          defaultChecked
                        />
                        <label className="form-check-label small" htmlFor="customCheck7">
                      ...
                      <div className="form-check mb-2px">
                        <input
                          ...
                          defaultChecked
                        />
                        <label className="form-check-label small" htmlFor="customCheck8">
                      ...
                      <div className="form-check mb-2px">
                        <input
                          ...
                          defaultChecked
                        />
                        <label className="form-check-label small" htmlFor="customCheck9">
                          backend integration for data filter with daterange input
                        </label>
                      </div>
                    </div>
                  </div>
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-footer">
              <a href="#/" className="btn btn-outline-default" data-bs-dismiss="modal">
                Cancel
              </a>

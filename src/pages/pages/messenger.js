                ...
                <a href="#/" data-toggle="messenger-content" className="messenger-link active">
                  ...
                  <div className="messenger-info">
                    ...
                    <div className="messenger-text">
                      Roberto says Hey Gabe, can you forward me the meeting notes?
                    </div>
                  </div>
              ...
              <span className="dropdown">
                ...
                <div className="dropdown-menu fs-11px">
                  <a href="#/" className="dropdown-item d-flex align-items-center">
                    <i className="bi bi-pencil-square fs-14px my-n1 me-3 ms-n2"></i> EDIT
                  </a>
                  <a href="#/" className="dropdown-item d-flex align-items-center">
                    <i className="bi bi-info-circle fs-14px my-n1 me-3 ms-n2"></i> INFO
                  </a>
                  <a href="#/" className="dropdown-item d-flex align-items-center">
                    <i className="bi bi-bell-slash fs-14px my-n1 me-3 ms-n2"></i> MUTE
                  </a>
                  <a href="#/" className="dropdown-item d-flex align-items-center">
                    <i className="bi bi-x-circle fs-14px my-n1 me-3 ms-n2"></i> CLEAR CHAT HISTORY
                  </a>
                  <div className="dropdown-divider"></div>
                  <a href="#/" className="dropdown-item d-flex align-items-center text-danger">
                    <i className="bi bi-trash fs-14px my-n1 me-3 ms-n2"></i> DELETE AND LEAVE
                  </a>
                </div>
              </span>
            </div>
              ...
              <div className="widget-chat">
                ...
                <div className="widget-chat-item">
                  ...
                  <div className="widget-chat-content">
                    ...
                    <div className="widget-chat-message">
                      Yes, we are going to use this slide. But we will have only 5 minutes to
                      present it.
                    </div>
                ...
                <div className="widget-chat-item">
                  ...
                  <div className="widget-chat-content">
                    <div className="widget-chat-name">Roberto Lambert</div>
                    <div className="widget-chat-message">Thank you! I should be there by 9:10.</div>
                    <div className="widget-chat-status">2:25PM</div>
                  </div>
                </div>
                <div className="widget-chat-item reply">
                  <div className="widget-chat-content">
                    <div className="widget-chat-message last">Don't rush. I've got it covered.</div>

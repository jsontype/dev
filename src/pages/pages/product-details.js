          ...
          <Card className="mb-4">
            ...
            <CardBody>
              <div className="alert alert-success py-2">
                Add variants if this product comes in multiple versions, like different sizes or
                colors.
              </div>
              ...
              <table className="table fw-bold">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <input type="text" className="form-control" placeholder="#SKU000001" />
                    </td>
                    <td>
                    ...
                    <div className="row align-items-center">
                      ...
                      <div className="col-6 d-flex align-items-center">
                        <div className="form-check form-switch ms-auto">
                          ...
                          />
                          <label className="form-check-label" htmlFor="shippingAliExpress">
                            &nbsp;
                          </label>
                        </div>
                      </div>
                    ...
                    <div className="row align-items-center">
                      ...
                      <div className="col-6 d-flex align-items-center">
                        <div className="form-check form-switch ms-auto">
                          ...
                          />
                          <label className="form-check-label" htmlFor="shippingMegagoods">
                            &nbsp;
                          </label>
                        </div>
                      </div>
                    ...
                    <div className="row align-items-center">
                      ...
                      <div className="col-6 d-flex align-items-center">
                        <div className="form-check form-switch ms-auto">
                          ...
                          />
                          <label className="form-check-label" htmlFor="shippingWholesale2B">
                            &nbsp;
                          </label>
                        </div>
                      </div>
                    ...
                    <div className="row align-items-center">
                      ...
                      <div className="col-6 d-flex align-items-center">
                        <div className="form-check form-switch ms-auto">
                          ...
                          />
                          <label className="form-check-label" htmlFor="shippingSunriseWholesale">
                            &nbsp;
                          </label>
                        </div>
                      </div>
                  ...
                  <div>
                    ...
                    <div className="d-flex mt-1 text-inverse text-opacity-50 small">
                      ...
                      <div className="flex-1 ps-2">
                        <div className="mb-2">
                          Amazon is disconnected. Connect your Amazon Seller Central account to
                          continue using this sales channel.
                        </div>
                        <a href="#/">Learn more</a>
                      </div>
                    </div>
          ...
          <Card className="mb-4">
            ...
            <CardBody>
              ...
              <p className="mb-0 small text-inverse text-opacity-50">
                <i className="fa fa-question-circle fa-fw"></i> Add this product to a collection so

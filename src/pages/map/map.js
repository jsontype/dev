          ...
          <div className="row">
            <div className="col-xl-9">
              ...
              <div id="jsVectorMap" className="mb-5">
                <h4>jsVectorMap</h4>
                <p>
                  jsVectorMap is a lightweight Javascript library for creating interactive maps and
                  pretty data visualization. Please read the{' '}
                  <a
              ...
              <div id="googleMapReact" className="mb-5">
                ...
                <p>
                  ...
                  It allows you to render any React component on the Google Map. Please read the{' '}
                  <a
                ...
                <Card>
                  <CardBody>
                    <div className="h-300px">
                      <GoogleMapReact
                        defaultCenter={{ lat: 25.304304, lng: -90.06591800000001 }}
            ...
            <div className="col-xl-3">
              <NavScrollTo>
                <nav className="nav">
                  <a className="nav-link" href="#jsVectorMap" data-toggle="scroll-to">
                    jsVectorMap
                  </a>
                  <a className="nav-link" href="#googleMapReact" data-toggle="scroll-to">
                    Google Map React
                  </a>
                </nav>
              </NavScrollTo>

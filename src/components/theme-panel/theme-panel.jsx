...
function ThemePanel() {
  ...
  const [mode, setMode] = useState(
    localStorage && typeof localStorage.appMode !== 'undefined' ? localStorage.appMode : 'dark',
  )
  ...
  const [cover, setCover] = useState(
    localStorage && typeof localStorage.appCover !== 'undefined' ? localStorage.appCover : '',
  )
  ...
  return (
    <div className={'app-theme-panel' + (active ? ' active' : '')}>
      <div className="app-theme-panel-container">
        <a href="#/" onClick={toggleAppThemePanel} className="app-theme-toggle-btn">
                  ...
                  modeList.map((m, index) => (
                    <div className="col-6" key={index}>
                      <a
                        ...
                        className={'app-theme-mode-link ' + (mode === m.value ? 'active' : '')}
                      >
                        <div className="img">
                          <img
                            src={m.img}
              ...
              <div className="app-theme-list">
                {themeList.length > 0 &&
                  themeList.map((t, index) => (
                    <div
                      className={'app-theme-list-item ' + (theme === t.themeClass ? 'active' : '')}
                      key={index}
                    >
                      <a
                        href="#/"
              ...
              <div className="app-theme-cover">
                {coverList.length > 0 &&
                  coverList.map((c, index) => (
                    <div
                      className={'app-theme-cover-item ' + (cover === c.coverClass ? 'active' : '')}
                      key={index}
                    >
                      <a
                        href="#/"
                        ...
                        style={{ backgroundImage: 'url(' + c.coverThumbImage + ')' }}

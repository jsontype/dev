        ...
        <div className="menu-item dropdown dropdown-mobile-full">
          ...
          <div className="dropdown-menu dropdown-menu-end mt-1 w-300px fs-11px pt-1">
            ...
            {notificationData.length > 0 ? (
              ...
              <div className="dropdown-notification-item p-3 text-center">No record found</div>
            )}
        ...
        <div className="menu-item dropdown dropdown-mobile-full">
          ...
          <div className="dropdown-menu dropdown-menu-end me-lg-3 fs-11px mt-1">
            <Link to="/profile" className="dropdown-item d-flex align-items-center">
              PROFILE <i className="bi bi-person-circle ms-auto text-theme fs-16px my-n1"></i>
            </Link>
            <Link to="/email/inbox" className="dropdown-item d-flex align-items-center">
              INBOX <i className="bi bi-envelope ms-auto text-theme fs-16px my-n1"></i>
            </Link>
            <Link to="/calendar" className="dropdown-item d-flex align-items-center">
              CALENDAR <i className="bi bi-calendar ms-auto text-theme fs-16px my-n1"></i>
            </Link>
            ...
            <Link to="/pages/login" className="dropdown-item d-flex align-items-center">
